...
Eventually, we will need to make a separate app repository and end with a *bare* `make_test()` function, without storing it as a variable. For an example, look at the `app` directory at the [course repository](https://github.com/jaburgoyne/everyday2020).
